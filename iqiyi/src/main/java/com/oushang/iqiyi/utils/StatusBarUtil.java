...
public class StatusBarUtil {
    ...
    private static final String ACTION_SHOW_CUSTOM_STATUS_BAR = "com.android.intent.action.ACTION_SHOW_CUSTOM_STATUS_BAR";
    private static final String ACTION_HIDE_CUSTOM_STATUS_BAR = "com.android.intent.action.ACTION_HIDE_CUSTOM_STATUS_BAR";
    // Intent intent = new Intent(ACTION_SHOW_CUSTOM_STATUS_BAR); // 显隐广播保证成对出现，否则不会显示状态栏
    // intent.putExtra("packageName", "xxxx");   //显隐都要带上这个，xxx是自己的包名

    private static final String ACTION_SHOW_STATUS_BAR = "com.chinatsp.sytemui.ACTION_SHOW_STATUS_BAR";
    private static final String ACTION_HIDE_STATUS_BAR = "com.chinatsp.sytemui.ACTION_HIDE_STATUS_BAR";
    ...
    public static void showStatusBar(Context context) {
        if (context != null) {
            ...
            Intent intent = new Intent(ACTION_SHOW_STATUS_BAR);
            intent.putExtra("packageName", context.getPackageName());
            context.sendBroadcast(intent);
        }
    }
